...
| plano | VARCHAR(20) | Nao | Nao | Nao | Plano de assinatura |
| idiomaPreferencial | VARCHAR(20) | Nao | Nao | Nao | Idioma preferido de leitura |
...
| classificacao | VARCHAR(20) | Nao | Nao | Nao | Classificacao etaria |
...
| idioma | VARCHAR(20) | Nao | Nao | Nao | Idioma do capitulo |
